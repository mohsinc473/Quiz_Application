    ...
    var quizQuestion = [
        {
             ...
             Ans : "Coaxial cables provide effective protection against EMI during data transmissions.",
        ...
        {
             Question1 : {
             Q1 : "In case of fiber-optic cables, which transmission mode is used for transmitting data over long distances?",
             Ans : "Single mode",
             a : "Infrared",
             b : "Radio",
             c : "Single mode",
        ...
        {
             Question1 : {
             Q1 : "What is the maximum bandwidth that can be supported by fiber optics cable?",
             Ans : "2000 Mbps",
             a : "10 Mbps",
             b : "2000 Mbps",
             c : "50 Mbps",
        ...
        {
             Question1 : {
             Q1 : "Media Access Control (MAC) and Logical Link Control (LLC) are two sublayers of _________________.",
             Ans : "Data Link layer",
             a : "Session layer",
             b : "Network layer",
             c : "Data Link layer",
        ...
        {
             Question1 : {
             Q1 : "Radio waves and microwaves are used in which of the following communications?",
             Ans : "Wireless",
             a : "Voice over IP",
             b : "IP Telephony",
             c : "Enterprise",
